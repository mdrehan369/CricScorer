...
def displayplayer(master, data):
    ...
    back_btn = t.CTkButton(master=mainframe, text='',image=getImage('icons/arrow.png'), width=10, border_width=0, command=lambda :[mainframe.destroy, viewPlayer(master)],  )
...
def displayTeam(master, data):
    ...
    mainframe = t.CTkFrame(master=master, border_width=3, border_color='gray', corner_radius=30)
    mainframe.place(relx=0.5, rely=0.5, relwidth=0.95, relheight=0.95, anchor='center')
    back_btn = t.CTkButton(master=mainframe, text='',image=getImage('icons/arrow.png'), width=10, border_width=0, command=lambda :[mainframe.destroy, viewTeam(master)],  )
    back_btn.place(relx=0.05, rely = 0.05, anchor='center')
...
def newTeam(master):
    ...
    def addplayers():
        ...
        optionmenu = t.CTkOptionMenu(mainframe, values=options,  dropdown_fg_color='white',  corner_radius=5,   font=t.CTkFont(family='lucida', size=16), text_color='black')
    ...
    addbtn = t.CTkButton(sideframe,   text='Add Logo', font=t.CTkFont(family='roboto', size=18), border_color='black', border_width=2, text_color='black', command=changepic)
    ...
    addplayers_btn = t.CTkButton(mainframe,   text='Add Player', font=t.CTkFont(family='roboto', size=18), border_color='black', border_width=2, text_color='black', command=addplayers)
    addplayers_btn.place(relx=0.65, rely=0.5, anchor='center', relwidth=0.12, relheight=0.07)

    addteam = t.CTkButton(mainframe, text='Add Team', command=add,   border_color='black', text_color='black', font=t.CTkFont(family='lucida', size=18), border_width=2, corner_radius=5)

    captain = t.CTkOptionMenu(mainframe, values=options,  dropdown_fg_color='white',  corner_radius=5,   font=t.CTkFont(family='lucida', size=16), text_color='black')
    captain.set("Select Captain")

    vc_captain = t.CTkOptionMenu(mainframe, values=options,  dropdown_fg_color='white',  corner_radius=5,   font=t.CTkFont(family='lucida', size=16), text_color='black')
...
def newPlayer(master):
    ...
    add_profile = t.CTkButton(side_frame, text='Add Profile', font = t.CTkFont(family='lucida', size=18),   text_color='black', command=changepic, border_width=2, border_color='gray')
    ...
    t.CTkRadioButton(infoframe, text='Male', font=t.CTkFont(family='roboto', size=17), variable=gender, value='male',  border_color='gray',  border_width_checked=8).grid(row=1, column=1,padx=5)
    t.CTkRadioButton(infoframe, text='Female', font=t.CTkFont(family='roboto', size=17), variable=gender, value='female',  border_color='gray',  border_width_checked=8).grid(row=1, column=2)

    # t.CTkLabel(infoframe, text='Select Role : ', font=t.CTkFont(family='roboto', size= 18)).place(relx=0.6, rely=0.385, anchor='center')
    t.CTkOptionMenu(infoframe, values=roles, variable=role, font=t.CTkFont(family='roboto', size=17), corner_radius=5,   text_color='black',  ).place(relx=0.75, rely=0.43, anchor='center', relwidth=0.4)

    t.CTkLabel(infoframe, text='Batting Arm : ', font=t.CTkFont(family='roboto', size= 18)).place(relx=0.18, rely=0.5, anchor='center')
    t.CTkRadioButton(infoframe, text='Left', font=t.CTkFont(family='roboto', size=17), variable=batting_arm, value='left',  border_color='gray',  border_width_checked=8).grid(row=2, column=1,padx=5)
    t.CTkRadioButton(infoframe, text='Right', font=t.CTkFont(family='roboto', size=17), variable=batting_arm, value='right',  border_color='gray',  border_width_checked=8).grid(row=2, column=2)

    t.CTkLabel(infoframe, text='Bowling Arm : ', font=t.CTkFont(family='roboto', size= 18)).place(relx=0.63, rely=0.5, anchor='center')
    t.CTkRadioButton(infoframe, text='Left', font=t.CTkFont(family='roboto', size=17), variable=bowling_arm, value='left',  border_color='gray',  border_width_checked=8).grid(row=2, column=4,padx=5)
    t.CTkRadioButton(infoframe, text='Right', font=t.CTkFont(family='roboto', size=17), variable=bowling_arm, value='right',  border_color='gray',  border_width_checked=8).grid(row=2, column=5)
    ...
    t.CTkOptionMenu(infoframe, values=actions, variable=bowling_action, font=t.CTkFont(family='roboto', size=17), corner_radius=5,   text_color='black',  ).place(relx=0.75, rely=0.65, anchor='center', relwidth=0.4)

    t.CTkButton(infoframe, text='Save', border_color='gray',   corner_radius=5, command=savedata, border_width=2, font=t.CTkFont(family='roboto', size= 18), text_color='black').place(relx=0.5, rely=0.8, relwidth=0.15, relheight=0.08, anchor='center')
...
def viewPlayer(master):
    ...
    t.CTkButton(main_frame, image=getImage('icons/search.png'),  text='',  border_color='gray', border_width=2, command=lambda: search(search_bar.get(), master)).place(relx=0.78, rely=0.1, relwidth=0.05, relheight=0.06, anchor='center')
...
def viewTeam(master):
    ...
    t.CTkButton(mainframe, text="", image=getImage('icons/search.png'),   border_color="black", border_width=2, corner_radius=5).place(relx=0.82, rely=0.1, anchor="center", relwidth=0.05, relheight=0.07)
...
def changeTheme():
    # global dark_green, light_green, colorIndex

    # if(colorIndex > 1):
    #     colorIndex = 0
    
    # dark_green = colors[colorIndex][0]
    # light_green = colors[colorIndex][1]
    # colorIndex += 1
    # t.set_default_color_theme("blue")
...
class App(t.CTk):
    ...
    def __init__(self, width, height, title):
        ...
        top_frame = t.CTkFrame(self, width=800, height=40,  border_width=1, corner_radius=0)
        top_frame.pack(side='top', fill='x')
        

        side_frame = t.CTkFrame(self, width=0, height=600,  border_width=1, border_color='black', corner_radius=0)
        ...
        menu_btn = t.CTkButton(top_frame, image=getImage('icons/menu.png'), text='', width=10, command=openSidebar,   border_width=0, border_color='black',)
        menu_btn.place(relx= 0.01, rely= 0.15)
    
        x_btn = t.CTkButton(side_frame, image=getImage('icons/close.png'), text='', command=hideSidebar, width=10,   border_width=0, border_color='black',)
        ...
        self.indicator = t.CTkLabel(side_frame, text= ' ', width=3, font=('lucida', 16),)
        self.indicator.place(relx= 0.1, rely=1.9*0.1)

        home_btn = t.CTkButton(side_frame, text='Home', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/home.png'), command=lambda:focus(1.9))
        home_btn.place(relx=0.2, rely=i*0.1)
        i += 0.65


        new_match = t.CTkButton(side_frame, text='New Match', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/newmatch.png'),command=lambda:focus(2.55))
        new_match.place(relx=0.2, rely=i*0.1)
        i += 0.65

        new_player = t.CTkButton(side_frame, text='New Player', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/newplayer.png'),command=lambda:[focus(3.3), changepage('New Player', newPlayer, main_frame)])
        new_player.place(relx=0.2, rely=i*0.1)
        i += 0.65

        new_team = t.CTkButton(side_frame, text='New Team', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/newteam.png'),command=lambda:[focus(3.95), changepage("New Team", newTeam, main_frame)])
        new_team.place(relx=0.2, rely=i*0.1)
        i += 0.65

        view_player = t.CTkButton(side_frame, text='View Player', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/viewplayer.png'),command=lambda:[focus(4.6), changepage('View Player', viewPlayer, main_frame)])
        view_player.place(relx=0.2, rely=i*0.1)
        i += 0.65


        view_team = t.CTkButton(side_frame, text='View Team', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/viewteam.png'),command=lambda:[focus(5.25), changepage("View Team", viewTeam, main_frame)])
        view_team.place(relx=0.2, rely=i*0.1)
        i += 0.65

        # edit_player = t.CTkButton(side_frame, text='Edit Player', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/editplayer.png'),command=lambda:[focus(5.9), changepage('Edit Player', editPlayer, main_frame)])
        # edit_player.place(relx=0.2, rely=i*0.1)
        # i += 0.65

        # edit_team = t.CTkButton(side_frame, text='Edit Team', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/editteam.png'),command=lambda:focus(6.55))
        # edit_team.place(relx=0.2, rely=i*0.1)
        # i += 0.65

        themes = t.CTkButton(side_frame, text='Themes', font=t.CTkFont(family='lucida',size= 16),  text_color='black',  compound='left', border_color=light_green, width=50, image=getImage('icons/themes.png'),command=lambda:[focus(5.2), changeTheme()])
        themes.place(relx=0.2, rely=i*0.1)
        i += 0.65

        btn = t.CTkButton(side_frame, text='Exit', font=t.CTkFont('lucida', 16), command=self.destroy,   text_color='black', width=50, image=getImage('icons/exit.png'))
